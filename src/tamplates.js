...
// //   return row( col(`<h1> ${block.value}</h1>`), block.options.styles)
// // }
...
// //   const html = `<img  src="${block.value}" alt= "${alt}"  style ="${imageStyles}"/>`////SMTH WRONG WITH SRC
...
///БЫло до использования ООП и solid